 ...
 * thin proxy — it delegates all logic to the autoloaded Render_Map class so
 * that the render.php files stay trivial and easy to reason about.
 *
...
// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Render_Map is responsible for escaping its output.
echo \Kntnt\Gpx_Blocks\Rendering\Render_Map::render( $attributes, $content, $block );
