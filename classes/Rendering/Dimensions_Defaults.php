 ...
 * `min-height` (Map's `30vh`, Elevation's `15vh`) onto the parsed block's
 * `attrs` before WordPress renders the block, so every downstream consumer —
 ...
 * `min-height: unset` and the wrapper would have no height.
 *
