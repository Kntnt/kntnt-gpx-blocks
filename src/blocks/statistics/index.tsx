/**
 * GPX Statistics block registration entry point.
 *
 ...
 *
 * Statistics has no frontend JavaScript: it is a server-only block with no
 * Interactivity API store, so there is no view.ts and block.json declares no
 * viewScriptModule.
 *
...
import { StatisticsEdit } from './edit';
