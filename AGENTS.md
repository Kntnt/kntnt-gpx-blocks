...
| Touching the GPX Statistics variation or its bindings source | [`docs/blocks.md`](docs/blocks.md) (Statistics variation section) plus [`docs/architecture.md`](docs/architecture.md) |
